	...
	<v-dialog v-model="showModal" max-width="420">
		<v-card>
			...
			<v-card-text class="pt-6">
				<v-text-field v-model="mac" label="Key / MAC thiết bị" placeholder="VD: A1:B2:C3:D4:E5:F6"
					variant="outlined" clearable autofocus density="comfortable" prepend-inner-icon="mdi-key" counter
					maxlength="17" @input="mac = mac.toUpperCase()" />
			...
			<v-card-actions class="px-6 pb-6">
				...
				<v-btn color="primary" :disabled="!mac" @click="hanldeClaim">
